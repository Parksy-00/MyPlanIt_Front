...
<React.Fragment key={uuidv4()}>
  ...
  "center"}} className="template-all">
     ...
     <div style={{marginLeft:'0'}}className="template-title">{buy_plans.plan.name}</div>
     </div>

     <div style={{height: "8px"}}></div>
      <img className="template-photourl" src= {buy_plans.plan.intro_img_url} style={{width: '350px', height: '130px'}}></img>
      ...
      <img className="template-writerphoto" src= {buy_plans.plan.writer_img} style={{width: '40px', height: '40px',borderRadius:'20px'}}></img>
      <div style={{display: 'flex', flexDirection: 'column',marginLeft: '10px'}}>
      <div className="template-writerintro" style={{fontSize: '14px',color:'gray', height: '14px',marginBottom:"4px"}}>{buy_plans.plan.writer_intro}</div>
      <div style={{fontSize:'14px'}}>{buy_plans.plan.writer_name}</div>
      </div>
      </div>
