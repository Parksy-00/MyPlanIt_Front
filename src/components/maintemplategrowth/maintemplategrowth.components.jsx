...
function MainTemplateGrowth() {
    ...
    if (loading) return <div>  
     ...
     {/*  <div style={{width: '40px'}}></div>*/}
      ...
      <div style={{marginTop:"40vh", marginBottom:"auto", marginLeft:"40vw",marginRight:"auto"}}><Oval color="#7965f4" height="40px" width="40px" /></div><BottomNavBarPlan/>
...
<React.Fragment key={uuidv4()}>
  ...
  "center"}} className="template-all">
     ...
     <div style={{height: "8px"}}></div>
      ...
      <div className="template-writerintro" style={{fontSize: '14px',color:'gray', height: '14px',marginBottom:"4px"}}>{Growth.writer_intro}</div>
      <div style={{fontSize:'14px'}}>{Growth.writer_name}</div>
      </div>
      </div>
